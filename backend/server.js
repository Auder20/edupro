...
app.options('*', cors(corsOptions));
app.use('/api/users', authMiddleware, require('./src/routes/userRoute'));
app.use('/api/courses', authMiddleware, require('./src/routes/courseRoute'));
app.use('/api/enrollments', authMiddleware, require('./src/routes/enrrolmentRoute'));
...
app.use('/api/course-content', authMiddleware, require('./src/controllers/courseContentController'));
